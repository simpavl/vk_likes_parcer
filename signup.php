...
<form method="POST" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" >
	...
	<div class="form-group input-group">
	<span class="input-group-addon"><i class="fa fa-lock"></i></span>
	<input type="text" name="password_repeat" style="display:block" class="mx-auto" placeholder="repeat password">
	</div>
	<div class="form-group input-group">
	<button name="submit" class="mx-auto btn btn-def btn-block"  >register</button>
	</div>
</form>
</div>
...
$password_repeat = mysqli_real_escape_string($connection,trim($_POST['password_repeat']));
...
if($password == $password_repeat) {
	$query = "INSERT INTO likesparcer (username,password) VALUES ('$username', SHA('$password'))";
